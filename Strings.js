...
var STRINGS = {
  en: {
    ...
    "note.action.pin": "Keep on top · Ctrl + P",
    "note.action.unpin": "Back to the deck · Ctrl + P",
    ...
    "keys.pinIt": "Keep it on top, or take it back",
  ...
  es: {
    ...
    "note.action.pin": "Mantener arriba · Ctrl + P",
    "note.action.unpin": "Devolver al mazo · Ctrl + P",
    ...
    "all.action.pin": "Fijar",
    "all.action.unpin": "Soltar",
    ...
    "keys.pinIt": "Mantenerla arriba, o devolverla",
